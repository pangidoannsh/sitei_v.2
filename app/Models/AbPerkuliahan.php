...
class AbPerkuliahan extends Model
{
    use HasFactory;
    ...
    // App/Models/Perkuliahan.php
    public function rekapitulasiRps()
    {
        return $this->hasOne(AbRekapitulasiRps::class, 'perkuliahan_id', 'id');
    }
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($perkuliahan) {
            ...
            $lastPerkuliahan = self::where('mata_kuliah_id', $perkuliahan->mata_kuliah_id)->latest()->first();
