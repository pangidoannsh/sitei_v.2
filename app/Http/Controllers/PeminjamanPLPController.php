...
class PeminjamanPLPController extends Controller
{
    public function index()
    {
        ...
        return view('inventaris.daftarpinjamplp.index', [
            'pinjamans' => $pinjamans,
