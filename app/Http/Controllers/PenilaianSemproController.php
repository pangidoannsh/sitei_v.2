...
class PenilaianSemproController extends Controller
{
    ...
    public function store_pembimbing(Request $request, $id)
    {
        ...
        return redirect('/penilaian-sempro')->with('message', 'Nilai Berhasil Diinput!');
    }
    ...
    public function store_penguji(Request $request, $id)
    {
        ...
        $validatedData['penjadwalan_sempro_id'] = $id;
        ...
        $penilaian->penjadwalan_sempro_id = $validatedData['penjadwalan_sempro_id'];
        $penilaian->save();
