...
@section('content')
    <div class="container card p-4">
        ...
        <ol class="breadcrumb col-lg-12">
            ...
            <li><a href="/form" class="px-1">Jadwal (<span>{{ $jml_seminar_kp + $jml_sempro + $jml_sidang }}</span>)</a>
            </li>

            <span class="px-2">|</span>
            <li><a href="/riwayat-penjadwalan" class="breadcrumb-item active fw-bold text-success px-1">Riwayat Penjadwalan
                    (<span>{{ $jml_riwayat_seminar_kp + $jml_riwayat_sempro + $jml_riwayat_sidang }}</span>)</a></li>
        </ol>
                        ...
                        @if (auth()->user()->role_id == 2 || auth()->user()->role_id == 3 || auth()->user()->role_id == 4)
                            <td class="text-center">
                                ...
                                @if ($skripsi->revisi_skripsi == !null)
                                    <a formtarget="_blank" target="_blank"
                                        href="/penilaian-skripsi/riwayat-judul/{{ Crypt::encryptString($skripsi->id) }}"
                                        class="badge bg-warning p-2 mt-1" style="border-radius:20px;">Revisi Judul</a>
                                @endif
                            </td>
                        @elseif(auth()->user()->role_id == 1)
