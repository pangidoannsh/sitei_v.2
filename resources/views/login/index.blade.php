      ...
      @endif
        <form action="/" method="POST" class="text-center">
          @csrf
            ...
            <img class="mb-2" src="{{asset('assets/dist/img/unri.png')}}" alt="" width="100">
            <h1 class=" h3 mb-3 fw-bold">SIA ELEKTRO</h1>
            ...
            <button class="mt-2 w-100 btn btn-lg btn-primary" type="submit">Log in</button>
        </form>
