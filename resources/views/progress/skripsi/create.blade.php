            ...
            <div class="col-lg-8">
                <div class="dokumen-card">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 field">
                            <label for="formFile" class="form-label float-start">File Skripsi <small
                                    class="text-secondary">(Format .pdf | Maks. 10 MB) </small></label>
                        ...
                        <div class="mb-3 field">
                            <label for="formFile" class="form-label float-start">Link <small class="text-secondary">(Upload
                                    Goggle Drive) </small></label>
            ...
            <div class="col-lg-4">
                <div class="dokumen-card">
                    ...
                    <div class="mb-3 field">
                        ...
                        <label class="form-label ">BAB 4 <small class="text-secondary"> (Centang Bila
                                Selesai)</small></label> <br />
                        <div class="form-check">

                            <input type="checkbox" class="form-check-input " name="bab4[]" value="Hasil">Hasil <br />
                            <input type="checkbox" class="form-check-input " name="bab4[]"
                                value="Pembahasan">Pembahasan <br />
                        </div>
                    </div>

                    <div class="mb-3 field">

                        <label class="form-label ">BAB 5 <small class="text-secondary"> (Centang Bila
                                Selesai)</small></label> <br />
                        <div class="form-check">

                            <input type="checkbox" class="form-check-input " name="bab5[]"
                                value="Kesimpulan">Kesimpulan <br />
