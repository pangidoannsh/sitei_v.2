...
<head>
    ...
    <title>Detail Undangan Sidang Skripsi</title>
    <!-- Fonts -->
                    ...
                    <div class="card-header">
                        <div class="login-logo">
                            <img src="{{ asset('assets/dist/img/unri.png') }}" alt="SIA ELEKTRO" height="60"
                                width="60"> <br>
                            <b>SITEI</b>
                            <h6>Sistem Informasi Teknik Elektro dan Informatika</h6>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <strong
                            style="max-width: 450px; margin-bottom:10px; display: inline-block;">{{ $penjadwalan->judul_skripsi }}</strong><br>
                        ...
                        <strong>{{ Carbon::parse($penjadwalan->tanggal)->translatedFormat('l, d F Y') }}</strong><br>
