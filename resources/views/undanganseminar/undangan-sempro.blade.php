...
<html>
<head>
    <title>STI-4 Undangan Seminar Proposal</title>
    @php
        use Carbon\Carbon;
...
<body>
        ...
        <table width="100%" style="text-align: right; margin-top:-40px;">
            <tr>
                <td style="font-size:12pt;">
                    @if ($penjadwalan->mahasiswa->prodi->id == 1)
                        <strong style="border:1px solid #000; padding:4px">STE-4</strong>
                    @elseif ($penjadwalan->mahasiswa->prodi->id == 2)
                        <strong style="border:1px solid #000; padding:4px">STE-4</strong>
                    @else
                        <strong style="border:1px solid #000; padding:4px">STI-4</strong>
                    @endif
                </td>
            </tr>         
        </table>
    ...
    <table width="100%" style="font-family: Arial, sans-serif; margin-top:0px; line-height: 1.5">
        ...
        <tr>
            <td width="27%">Hal</td>
            <td>:</td>
            <td ><b><u>	Undangan Seminar Proposal Skripsi</u></b></td>
        </tr>
    </table>
    <table width="100%" style="font-family: Arial, sans-serif; margin-top:0px; line-height: 1.5">
        <tr class="text2">
    ...
    <table width="100%" style="font-family: Arial, sans-serif; margin-top:0px; line-height: 1.5">
        ...
        <tr>
            <td width="27%">Bersama ini kami mengundang Bapak/Ibu untuk  menghadiri  Seminar Proposal Skripsi pada  :</td>
        </tr>
    </table>
 ...
 <table width="100%" style="margin-top: 8px">
    ...
    <table width="100%" style="font-family: Arial, sans-serif; margin-top:0px; line-height: 1.5">
        ...
        <tr class="text2">
            <td width="70%">
                <ol>
    <li>Ujian seminar 60 menit (15 menit presentasi dan 30 menit untuk tanya jawab penguji).</li>
    <li>Rapat dan pengumuman hasil seminar: 15 menit.</li>
    <li>Ujian sidang dilaksanakan paling lambat 10 menit dari jadwal dan harus dihadiri oleh dosen pembimbing dan minimal 2 (dua) penguji.</li>
