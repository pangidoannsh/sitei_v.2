...
<div class="row text-center justify-content-center mb-5">
    ...
    <li class="step active"> 
     ...
     @if ($kp->status_kp == 'SEMINAR KP SELESAI' ) 
        ...
        <span class="mt-3 "> Tanggal disetujui <br></span>
        <span class="mt-3 text-bold">{{Carbon::parse($kp->tgl_disetujui_kpselesai)->translatedFormat('l, d F Y ')}}</span>
        <!-- <span class="mt-3 text-bold">{{Carbon::parse($kp->tgl_disetujui_kpti_10)->translatedFormat('l, d F Y H:i:s')}}</span> -->
     </li> 
     <li class="step "> 
            <div><i class="fas "></i>
...
@if ($kp->status_kp == 'SEMINAR KP SELESAI' )
<div class="mt-2">
    <a href="/kpti_10-kp/create/{{$kp->id}}" class="btn mahasiswa btn-success mb-3">Upload KPTI-10 / Bukti Penyerahan Laporan</a>
</div>
...
<div class="row">
    ...
    <ol class=" mt-2">
    <a href="/kpti10-kp/detail/{{($kp->id)}}" class="badge bg-success p-2 fas fa-eye"> Lihat Detail</a>
