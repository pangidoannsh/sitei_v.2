...
<body>
    ...
    <table width="100%" style="font-family: Arial, sans-serif; margin-top:20px; line-height: 1.5">
        ...
        <tr class="text2">
            ...
            <td>:</td>
            <td width="70%">{{Carbon::parse($pendaftaran_kp->tanggal_mulai)->translatedFormat('l, d F Y')}}</td>
        </tr>
    ...
    <table width="100%" style="font-family: Arial, sans-serif; margin-top:100px;">
        <tr>
            ...
            <td class="text" style="text-align: left;">
                <div class="container">
                    <p>Pekanbaru, {{Carbon::parse($pendaftaran_kp->tanggal_mulai)->translatedFormat('d F Y')}} </p>
                    <p>Dosen Penguji</p>
                    <div class="ttd">
                    ...
                    <br><br><br><br><br><br>
                    <strong style="text-decoration: underline;">{{$pendaftaran_kp->dosen_pembimbing_nip->nama}}</strong><br>NIP. {{$pendaftaran_kp->dosen_pembimbing_nip}}
                </div>
                <br>
            </td>
        </tr>
