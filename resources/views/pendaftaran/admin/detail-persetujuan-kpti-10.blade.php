...
@if (Str::length(Auth::guard('web')->user()) > 0)
  ...
  <div class="mb-3">
  <a formtarget="_blank" target="_blank" href="/surat-permohonan-kp/{{Crypt::encryptString($kp->id)}}" class="badge bg-dark p-2"style="border-radius:20px;">Cetak Surat Permohonan KP</a>
  </div>
  @endif
        ...
        <div class="modal fade" id="GFG2">
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-header bg-danger">
                    ...
                    @method('put')
                    @csrf
                    <button type="submit" class="btn bg-success" style="border-radius:5px;">  Ya</button>
                </form>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-header bg-success ">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="/kpti10/pembimbing/approve/{{$kp->id}}" method="POST">
                    @method('put')
                    @csrf
                    <button type="submit" class="btn bg-success" style="border-radius:5px;">  Ya</button>
                </form>
