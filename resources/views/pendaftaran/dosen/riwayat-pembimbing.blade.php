    ...
    <div class="container card p-4">
        ...
        <ol class="breadcrumb col-lg-12">
            ...
            @if (Str::length(Auth::guard('dosen')->user()) > 0)
                ...
                <li><a href="/kp-skripsi/pembimbing-penguji/riwayat-seminar"
                        class="breadcrumb-item active fw-bold text-success px-1">Riwayat
                        (<span>{{ $jml_riwayat_kp + $jml_riwayat_sempro + $jml_riwayat_sidang }}</span>)</a></li>
            @endif
    ...
    @endif -->
                                ...
                                @if ($kp->penguji_nip == auth()->user()->nip)
                                    <a formtarget="_blank" target="_blank"
                                        ...
                                        class="badge bg-info mt-2 p-2"style="border-radius:20px;">Perbaikan</a>
                                    <a formtarget="_blank" target="_blank"
                                        href="/nilai-kp/{{ Crypt::encryptString($kp->id) }}"
                                ...
                                @if ($kp->pembimbing_nip == auth()->user()->nip)
                                    <a formtarget="_blank" target="_blank"
                                        ...
                                        class="badge bg-info mt-2 p-2"style="border-radius:20px;">Perbaikan Penguji</a>
                                    <a formtarget="_blank" target="_blank"
                    ...
                    @foreach ($penjadwalan_skripsis_draf as $skripsi)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/penilaian-skripsi/draft-ba/{{ Crypt::encryptString($skripsi->id) }}"
                                    class="badge bg-success p-2"style="border-radius:20px;">Draft BA</a>
                            </td>
                        </tr>
                    @endforeach
