...
@if (Str::length(Auth::guard('dosen')->user()) > 0)
  ...
  <div class="mb-3">
  <a formtarget="_blank" target="_blank" href="/surat-permohonan-kp/{{Crypt::encryptString($kp->id)}}" class="badge bg-dark p-2 fas fa-download">  Unduh Surat Permohonan KP</a>
  </div>
  @endif
