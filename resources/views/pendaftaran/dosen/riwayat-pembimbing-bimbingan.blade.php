    ...
    <div class="container card p-4">
        ...
        <ol class="breadcrumb col-lg-12">
            ...
            @if (Str::length(Auth::guard('dosen')->user()) > 0)
                ...
                <span class="px-2">|</span>
                <li><a href="/pembimbing/kerja-praktek" class="px-1">Bimbingan KP
                        (<span>{{ $jml_bimbingankp }}</span>)</a>
                </li>
                <span class="px-2">|</span>
                <li><a href="/pembimbing/skripsi" class="px-1">Bimbingan Skripsi
                        (<span>{{ $jml_bimbingan_skripsi }}</span>)</a>
                </li>
                <span class="px-2">|</span>
        ...
        <div class="container-fluid">
            ...
            <div class="d-none d-md-flex justify-content-between mb-3 filter">
                <div class="d-flex align-items-center">
                    <div class="dataTables_length input-group" style="width: max-content;">
                        ...
                        <select id="lengthMenuRiwayatKPSkripsi" class="custom-select custom-select-md rounded-3 py-1"
                            style="width: 55px;">
                ...
                <div class="dataTables_filter input-group" style="width: max-content;">
                    ...
                    <input type="search" class="form-control form-control-md rounded-3 py-1"
                        id="searchFilterRiwayatKPSkripsi" placeholder="">
                </div>
            </div>
            ...
            <div class="d-flex flex-wrap justify-content-center gap-3 filter d-block d-md-none">
                <div class="dataTables_length input-group" style="width: max-content;">
                    ...
                    <select id="lengthMenuMobileRiwayatKPSkripsi" class="custom-select custom-select-md rounded-3 py-1"
                        style="width: 55px;">
                        <option value="50">50</option>
                        <option value="100">100</option>
                        <option value="150">150</option>
                ...
                <div class="input-group" style="width: max-content;">
                    ...
                    <select id="statusFilterMobileRiwayatKPSkripsi" class="custom-select custom-select-md rounded-3 py-1"
                        style="width: 83px;">
                        <option value="">Semua</option>
                        @foreach ($unique_statuses as $status)
                            <option value="{{ $status }}">{{ $status }}</option>
            ...
            <div class="d-flex flex-wrap justify-content-center gap-3 mb-3 filter d-block d-md-none">
                <div class="dataTables_filter input-group mt-3" style="width: max-content;">
                    ...
                    <input type="search" class="form-control form-control-md rounded-3 py-1"
                        id="searchFilterMobileRiwayatKPSkripsi" placeholder="">
                </div>
            </div>

            <table class="table table-responsive-lg table-bordered table-striped" width="100%"
                id="datatablesriwayatkpdanskripsi">
                ...
                <tbody>
                    ...
                    @foreach ($pendaftaran_kp as $kp)
                        ...
                        <tr>
                            ...
                            @php
                                $tanggalMulaiKP = $kp->tgl_disetujui_balasan
                                    ? Carbon::parse($kp->tgl_disetujui_balasan)
                                    : null;
                                $tanggalSelesai = $kp->tgl_disetujui_kpti_10_kaprodi
                                    ? Carbon::parse($kp->tgl_disetujui_kpti_10_kaprodi)
                                    : null;

                                $durasiKP = $tanggalMulaiKP ? $tanggalMulaiKP->diffInMonths($tanggalSelesai) : null;
                                $bulan = $durasiKP ? floor($durasiKP) : null;
                                $hari = $tanggalMulaiKP
                                    ? $tanggalMulaiKP->addMonths($bulan)->diffInDays($tanggalSelesai)
                                    : null;
                            @endphp
                            ...
                            <td class="text-center">
                                <a href="/kpti10/detail/riwayat/pembimbingprodi/{{ $kp->id }}"
                    ...
                    @foreach ($pendaftaran_skripsi as $skripsi)
                        ...
                        <tr>
                            ...
                            @php
                                $tanggalMulaiSkripsi = $skripsi->tgl_disetujui_usuljudul_kaprodi
                                    ? Carbon::parse($skripsi->tgl_disetujui_usuljudul_kaprodi)
                                    : null;
                                $tanggalSelesai = $skripsi->tgl_disetujui_sti_17_koordinator
                                    ? Carbon::parse($skripsi->tgl_disetujui_sti_17_koordinator)
                                    : null;
        ...
        <div class="container-fluid">
            ...
            <div class="d-none d-md-flex justify-content-between mb-3 filter">
                <div class="d-flex align-items-center">
                    <div class="dataTables_length input-group" style="width: max-content;">
                        ...
                        <select id="lengthMenu" class="custom-select custom-select-md rounded-3 py-1"
                            style="width: 55px;">
                            <option value="50">50</option>
                            <option value="100">100</option>
                            <option value="150">150</option>
                    ...
                    <div class="input-group ml-3" style="width: max-content;">
                        ...
                        <select id="seminarFilter" class="custom-select custom-select-md rounded-3 py-1 text-capitalize"
                            style="width: 83px;">
                    ...
                    <div class="input-group ml-3" style="width: max-content;">
                        ...
                        <select id="bulanFilter" class="custom-select custom-select-md rounded-3 py-1 text-capitalize"
                            style="width: 83px;">
                            <option value="" selected>Semua</option>
                    ...
                    <div class="input-group ml-3" style="width: max-content;">
                        ...
                        <select id="tahunFilter" class="custom-select custom-select-md rounded-3 py-1 text-capitalize"
                            style="width: 83px;">
                            <option value="" selected>Semua</option>
                ...
                <div class="dataTables_filter input-group" style="width: max-content;">
                    ...
                    <input type="search" class="form-control form-control-md rounded-3 py-1" id="searchFilter"
                        placeholder="">
                </div>
            </div>
            ...
            <div class="d-flex flex-wrap justify-content-center gap-3 filter d-block d-md-none">
                <div class="dataTables_length input-group" style="width: max-content;">
                    ...
                    <select id="lengthMenuMobile" class="custom-select custom-select-md rounded-3 py-1"
                        style="width: 55px;">
                        <option value="50">50</option>
                        <option value="100">100</option>
                        <option value="150">150</option>
                ...
                <div class="input-group" style="width: max-content;">
                    ...
                    <select id="seminarFilterMobile" class="custom-select custom-select-md rounded-3 py-1 text-capitalize"
                        style="width: 83px;">
                        <option value="" selected>Semua</option>
                        @foreach ($jenis_seminar as $jenis)
                            <option value="{{ $jenis }}" class="text-capitalize">{{ $jenis }}</option>
            ...
            <div class="d-flex flex-wrap justify-content-center gap-3 filter d-block d-md-none">
                <div class="input-group mt-3" style="width: max-content;">
                    ...
                    <select id="bulanFilterMobile" class="custom-select custom-select-md rounded-3 py-1 text-capitalize"
                        style="width: 83px;">
                        <option value="" selected>Semua</option>
                        @foreach ($bulan_options as $bulan)
                            <option value="{{ $bulan }}" class="text-capitalize">{{ $bulan }}</option>
                ...
                <div class="input-group mt-3" style="width: max-content;">
                    ...
                    <select id="tahunFilterMobile" class="custom-select custom-select-md rounded-3 py-1 text-capitalize"
                        style="width: 83px;">
                        <option value="" selected>Semua</option>
                        @foreach ($tahun_options as $tahun)
                            <option value="{{ $tahun }}" class="text-capitalize">{{ $tahun }}</option>
            ...
            <div class="d-flex flex-wrap justify-content-center gap-3 mb-3 filter d-block d-md-none">
                <div class="dataTables_filter input-group mt-3" style="width: max-content;">
                    ...
                    <input type="search" class="form-control form-control-md rounded-3 py-1" id="searchFilterMobile"
                        placeholder="">
                </div>
            </div>

            <table class="table table-responsive-lg table-bordered table-striped" style="width:100%"
                id="datatablesriwayatseminar">
                <thead class="table-dark">
                    <tr>
                        <th class="text-center" scope="col">NIM</th>
                        <th class="text-center" scope="col">Nama</th>
    ...
    @endif -->
                            ...
                            <td class="text-center">
                                ...
                                @if ($kp->penguji_nip == auth()->user()->nip)
                                    ...
                                    <a formtarget="_blank" target="_blank"
                                        href="/nilai-kp/{{ Crypt::encryptString($kp->id) }}"
...
@else
    ...
    @endif -->
                            ...
                            <td class="text-center">
                                ...
                                <br>
                                <a formtarget="_blank" target="_blank"
                                    href="/nilai-sempro/{{ Crypt::encryptString($sempro->id) }}"
                                ...
                                @if ($sempro->pembimbingsatu_nip == auth()->user()->nip || $sempro->pembimbingdua_nip == auth()->user()->nip)
                                    <a formtarget="_blank" target="_blank"
                                        ...
                                        class="badge bg-danger p-2 mt-1" style="border-radius:20px;">Perbaikan Penguji
                                        1</a>
                                    <a formtarget="_blank" target="_blank"
                                        href="/perbaikan-pengujisempro/{{ Crypt::encryptString($sempro->id) }}/{{ $sempro->pengujidua->nip }}"
                                        class="badge bg-warning p-2 mt-1" style="border-radius:20px;">Perbaikan Penguji
                                        2</a>
                                    @if ($sempro->pengujitiga == !null)
                                        <a formtarget="_blank" target="_blank"
                                            href="/perbaikan-pengujisempro/{{ Crypt::encryptString($sempro->id) }}/{{ $sempro->pengujitiga->nip }}"
                                            class="badge bg-success p-2 mt-1" style="border-radius:20px;">Perbaikan
                                            Penguji
                                            3</a>
                                    @endif
                                @endif
    ...
    @endif -->
        ...
        <div class="d-flex align-items-end flex-column fixed-bottom bd-highlight mb-5">
            <div class="mt-auto p-2 bd-highlight ">
                <span onclick="scrollToTop()" id="scrollToTopBtn" title="Kembali ke Atas"
                    style="width: 40px; height: 40px; cursor: pointer;"><i
                        class="fas fa-chevron-circle-up fa-lg fs-2"></i></span>
            </div>
        </div>
        <br>
        <br>
