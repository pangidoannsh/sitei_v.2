...
<div class="card">
      <div class="card-body">
        ...
        <p class="card-text text-start"> {{Carbon::parse($kp->tanggal_rencana)->translatedFormat('l, d F Y')}}</p>
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-header bg-danger">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="/permohonankp/pembimbing/tolak/{{$kp->id}}" method="POST">
                    @method('put')
                    @csrf
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-header bg-success ">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="/permohonankp/pembimbing/approve/{{$kp->id}}" method="POST">
                    @method('put')
                    @csrf
                    <button type="submit" class="btn " style="border-radius:5px;">  Ya</button>
                </form>
