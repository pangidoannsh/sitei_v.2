...
@section('content')
    ...
    <a href="/persetujuan-kp-skripsi" class="btn btn-success py-1 px-2 mb-3"><i class="fas fa-arrow-left fa-xs"></i> Kembali
        <a>
                ...
                <div class="container">
                    <div class="row rounded shadow-sm">
                        <div class="col-lg-6 col-md-12 bg-white px-4 py-3 mb-2 rounded-start">
                            ...
                            <hr>
                            <p class="card-title text-secondary text-sm ">STI/TE-23/SURAT PERNYATAAN PERPANJANGAN REVISI
                                SKRIPSI</p>
