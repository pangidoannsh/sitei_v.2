...
@section('sub-title')
Kerja Praktek Mahasiswa Bimbingan
@endsection
...
<a href="/kp-skripsi/seminar-kp" class="btn bg-light border  border-bottom-0">Seminar</a>
...
<a href="/pembimbing/kerja-praktek" class="btn btn-outline-success border  border-bottom-0 active" >
