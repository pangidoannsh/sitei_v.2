...
<div class="container">
    <div class="row rounded shadow-sm">
      ...
      <p class="card-title text-secondary text-sm" >Judul diusulkan</p>
        ...
        <p class="card-text text-start" ><a formtarget="_blank" target="_blank" href="{{asset('storage/' .$skripsi->krs_berjalan )}}" class="badge bg-dark px-3 py-2">Lihat</a></p>
        <p class="card-title text-secondary text-sm " >Kartu Hasil Studi</p>
        <p class="card-text text-start" ><a formtarget="_blank" target="_blank" href="{{asset('storage/' .$skripsi->khs )}}" class="badge bg-dark px-3 py-2">Lihat</a></p>
        <p class="card-title text-secondary text-sm " >Transkip Nilai</p>
        <p class="card-text text-start" ><a formtarget="_blank" target="_blank" href="{{asset('storage/' .$skripsi->transkip_nilai )}}" class="badge bg-dark px-3 py-2">Lihat</a></p>
        </div>
        <div class="col-lg-6 col-md-12 bg-white rounded-end px-4 py-3 mb-2">
        ...
        <p class="card-text text-start" ><span class="badge p-2 bg-secondary text-bold px-3" style="border-radius:20px;">{{$skripsi->status_skripsi}}</span></p>
        @endif
...
<div class="container">
    @if (Str::length(Auth::guard('web')->user()) > 0)
      ...
      <div class="mb-5 mt-3 float-right">
       <div class="row row-cols-2">
    <div class="col">
        <button onclick="tolakUsulJudulAdmin()"  class="btn btn-danger py-2 px-3 mb-3" data-bs-toggle="tooltip" title="Tolak" >Tolak</button>
</div>
    <div class="col">
