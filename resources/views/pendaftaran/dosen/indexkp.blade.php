...
<div class="btn-group menu-dosen scrollable-btn-group col-md-12">
  ...
  <a href="/kerja-praktek" class="btn btn-outline-success border  border-bottom-0 active">
   <span class="button-text">Data KP (<strong id="waitingApprovalCount"></strong>) </span>
  <span class="badge-link">
...
<ol class="breadcrumb col-lg-12">
  ...
  @if (Str::length(Auth::guard('dosen')->user()) > 0)
        ...
        <li><a href="/kerja-praktek" class="breadcrumb-item active fw-bold text-black px-1">Data KP</a></li>
