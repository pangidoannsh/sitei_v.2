...
<div class="container float-start">
  <a href="/pembimbing/kerja-praktek" class="badge bg-success p-2 mb-3 float-start"> Kembali <a>
</div>
@endif
@if (Str::length(Auth::guard('web')->user()) > 0)
<div class="container float-start">
  <a href="/kerja-praktek/admin/index" class="badge bg-success p-2 mb-3 float-start"> Kembali <a>
</div>
  @endif
...
<div class="mb-5 mt-3 float-right">
    ...
    @if (Str::length(Auth::guard('dosen')->user()) > 0)
        ...
        <div class="row row-cols-2">
    <div class="col">
        <form action="/usulankp/koordinator/tolak/{{$kp->id}}" class="tolak-usulankp-koordinator" method="POST"> 
    @method('put')
    @csrf
    ...
    @if (Str::length(Auth::guard('dosen')->user()) > 0)
        ...
        <div class="row row-cols-2">
    <div class="col">
        <form action="/usulankp/kaprodi/tolak/{{$kp->id}}" class="tolak-usulankp-kaprodi" method="POST"> 
    @method('put')
    @csrf
    <button class="btn btn-danger badge p-2 px-3">Tolak</i></button>
</form>
...
$('.tolak-usulankp-koordinator').submit(function(event) {
    event.preventDefault();
    Swal.fire({
        title: 'Tolak Usulan KP!',
        text: "Apakah Anda Yakin?",
...
$('.tolak-usulankp-kaprodi').submit(function(event) {
    event.preventDefault();
    Swal.fire({
        title: 'Tolak Usulan KP!',
        text: "Apakah Anda Yakin?",
