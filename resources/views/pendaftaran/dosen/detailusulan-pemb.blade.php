...
@section('content')
                ...
                <div class="row rounded shadow-sm">
                    <div class="col-lg-6 col-md-12 px-4 py-3 mb-2 bg-white rounded-start">
                        ...
                        <p class="card-text  text-start"><a formtarget="_blank" target="_blank"
                                href="{{ asset('storage/' . $kp->krs_berjalan) }}" class="badge bg-dark px-3 py-2">Buka</a>
                        </p>
                        <p class="card-title text-secondary text-sm ">Transkip Nilai</p>
                        <p class="card-text  text-start"><a formtarget="_blank" target="_blank"
                                href="{{ asset('storage/' . $kp->transkip_nilai) }}"
                        ...
                        <p class="card-text text-start mb-md-4">
                    ...
                    @if ($kp->keterangan == 'Menunggu persetujuan Pembimbing' && $kp->status_kp == 'USULAN KP')
                        <div class="mb-5 mt-3 float-right">
                            <div class="row row-cols-2">
                                <div class="col">
                                    <button onclick="tolakUsulanKPPembimbing()" class="btn btn-danger py-2 px-3 mb-3"
                                        data-bs-toggle="tooltip" title="Tolak">Tolak</button>
                                </div>
                                <div class="col">
                                    <form action="/usulankp/pembimbing/approve/{{ $kp->id }}"
                                        class="setujui-usulankp-pemb" method="POST">
                                        @method('put')
                                        @csrf
                    ...
                    @if (Auth::guard('web')->user()->role_id == 2 ||
                        ...
                        @if ($kp->keterangan == 'Menunggu persetujuan Admin Prodi' && $kp->status_kp == 'USULAN KP')
                            <div class="mb-5 mt-3 float-right">
                                <div class="row row-cols-2">
                                    <div class="col">
                                        <button onclick="tolakUsulanKPAdmin()" class="btn btn-danger py-2 px-3 mb-3"
                                            data-bs-toggle="tooltip" title="Tolak">Tolak</button>
                                    </div>
                                    <div class="col">
    ...
    <div class="mb-5 mt-3 float-right">
        ...
        @method('put')
        @csrf
        <button class="btn btn-danger py-2 px-3 mb-3">Tolak</i></button>
    </form>
    </div>
        <div class="col">
