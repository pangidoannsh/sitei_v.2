    ...
    <div class="container pb-4 ">
                    ...
                    @foreach ($dosenn as $dosen)
                        ...
                        <tr>
                            ...
                            <td class="text-center @if ($dosen->pendaftaran_skripsi1_count + $dosen->pendaftaran_skripsi2_count >= $kapasitas->kapasitas_skripsi) bg-danger @endif bg-info">
                                {{ $dosen->pendaftaran_skripsi1_count + $dosen->pendaftaran_skripsi2_count }}</td>
                            <td class="text-center">
        ...
        <div class="card pt-2 mt-5">
            <div class="card-body">
                ...
                <span class="card-text">Kuota maksimal bimbingan Skripsi adalah <b> {{ $kapasitas->kapasitas_skripsi }}
                        Orang.</span>
            </div>
        </div>
