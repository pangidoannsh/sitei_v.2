...
<head>
    <title>STI/TE-1 Surat Permohonan Pengajuan Topik Skripsi</title>
    @php
        use Carbon\Carbon;
...
<body>
    <div class="isi">
        ...
        <table width="100%" style="text-align:center; margin-top:0px;">
            <tr>
                <td style="font-size:12pt;text-decoration: underline;">
                    <strong>SURAT PERMOHONAN PENGAJUAN TOPIK SKRIPSI</strong>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="text-align: right; margin-top:-40px;">
            <tr>
                <td style="font-size:12pt;">
                    @if ($pendaftaran_skripsi->mahasiswa->prodi->id == 1)
                        <strong style="border:1px solid #000; padding:4px">STE-1</strong>
                    @elseif ($pendaftaran_skripsi->mahasiswa->prodi->id == 2)
                        <strong style="border:1px solid #000; padding:4px">STE-1</strong>
                    @else
                        <strong style="border:1px solid #000; padding:4px">STI-1</strong>
                    @endif
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="font-family: Arial, sans-serif; margin-top:0px; line-height: 1.5">
            <tr class="text2">
                <td width="27%">Mengajukan permohonan topik skripsi, dengan memenuhi syarat-syarat berikut :</td>
            </tr>
            <tr class="text2">
                <td style="padding-left: 20px;" width="27%">a. Telah lulus 75 SKS mata kuliah</td>
            </tr>
            <tr class="text2">
                <td style="padding-left: 20px;" width="27%">b. Telah lulus mata kuliah Metode Penelitian</td>
        </table>
        ...
        <table width="100%" style="font-family: Arial, sans-serif; margin-top:0px; line-height: 1.5">
            ...
            <tr class="text2">
                <td style="padding-left: 20px;" width="27%">1. Fotokopi Transkrip atau Rapor mahasiswa.</td>
            </tr>
        </table>
            ...
            <tr>
                <td class="text" style="text-align: left;">
                    <div class="container">
                        <p>Mengetahui,</p>
                        @if ($pendaftaran_skripsi->mahasiswa->prodi->id == 1)
                            <p style="margin-top:-10px;">Koordinator Prodi Teknik Elektro D3</p>
                        @elseif ($pendaftaran_skripsi->mahasiswa->prodi->id == 2)
                            <p style="margin-top:-10px;">Koordinator Prodi Teknik Elektro S1</p>
                        @else
                            <p style="margin-top:-10px;">Koordinator Prodi Teknik Informatika</p>
                        @endif
                ...
                <td class="text" style="text-align: left;">
                    <div class="container" style="float: right; margin-top:-180px;">
                        <p style="">Pekanbaru, {{ Carbon::parse($pendaftaran_skripsi->tgl_created_usuljudul)->translatedFormat('d F Y') }} </p>
                        ...
                        <br><br><br><br><br><br>
                            <strong
                                style="text-decoration: underline;">{{ $pendaftaran_skripsi->mahasiswa->nama }}</strong><br>NIM.{{ $pendaftaran_skripsi->mahasiswa->nim }}
                    </div>
                    <br>
                </td>
            </tr>
