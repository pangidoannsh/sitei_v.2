            ...
            <div>
                <div class="row">
                    <div class="col">
                        ...
                        <div class="mb-3">
                            <label for="formFile" class="form-label pb-0">Transkip Nilai<span
                                    class="text-danger">*</span><small class="text-secondary">( Format .pdf | Maks. 200 KB )
                                </small> </label>
                            ...
                            <select name="pembimbing_1_nip" id="pembimbing_1_nip"
                                ...
                                @foreach ($dosens as $dosen)
                                    <option value="{{ $dosen->nip }}"
                                        {{ old('pembimbing_1_nip') == $dosen->nama ? 'selected' : null }}>
                                        {{ $dosen->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="pembimbing_2_nip" id="pembimbing_2_nip"
                                ...
                                @foreach ($dosens as $dosen)
                                    <option value="{{ $dosen->nip }}"
                                        {{ old('pembimbing_2_nip') == $dosen->nama ? 'selected' : null }}>
                                        {{ $dosen->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <button type="submit" class="btn mt-4 btn-lg btn-success float-right" title="Usulkan Judul">Usulkan
                            Judul</button>
