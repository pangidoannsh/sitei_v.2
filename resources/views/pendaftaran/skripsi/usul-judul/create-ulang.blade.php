...
<form action="/usuljudul-ulang/create/{{$skripsi->id}}" method="POST" enctype="multipart/form-data">
        @csrf
    <div>
    <div class="row">
    ...
    <div class="mb-3">
            <label for="formFile" class="form-label pb-0">KRS Semester Berjalan</label>
    ...
    <div class="mb-3">
            <label for="formFile" class="form-label pb-0">Kartu Hasil Studi</label>
    ...
    <div class="mb-3">
            <label for="formFile" class="form-label pb-0">Transkip Nilai</label>
