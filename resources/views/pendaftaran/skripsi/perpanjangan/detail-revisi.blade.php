        ...
        <div class="container">
            <div class="row rounded shadow-sm">
                <div class="col-lg-6 col-md-12 bg-white px-4 py-3 mb-2 rounded-start">
                    ...
                    <hr>
                    <p class="card-title text-secondary text-sm ">STI/TE-23/SURAT PERNYATAAN PERPANJANGAN REVISI SKRIPSI</p>
                    ...
                    @if (
                        ...
                        <div class="mb-5 mt-3 float-right">
                            <div class="row row-cols-2">
                                <div class="col">
                                    <button onclick="tolakPerpanjanganRevisiKaprodi()" class="btn btn-danger py-2 px-3 mb-3"
