                ...
                <div class="row mt-3">
                    <div class="col">
                        <div class="mb-3 field">
                            ...
                            <input type="number" name="kapasitas_kp"
                                class="form-control @error('kapasitas_kp') is-invalid @enderror"
                                value="{{ old('kapasitas_kp', $kp->kapasitas_kp) }}">
                            @error('kapasitas_kp')
                        ...
                        <div class="mb-3">
                            <label class="form-label pb-0">Kapasitas Bimbingan Skripsi<span
                                    class="text-danger">*</span></label>
                            <input type="number" name="kapasitas_skripsi"
                                class="form-control @error('kapasitas_skripsi') is-invalid @enderror"
                                value="{{ old('kapasitas_skripsi', $kp->kapasitas_skripsi) }}">
                ...
                <div class="container">
                    <p class="developer">Dikembangkan oleh Prodi Teknik Informatika UNRI <span
                        ...
                        <a class="text-success fw-bold" formtarget="_blank" target="_blank" href="/developer/m-seprinaldi">
                            M. Seprinaldi</a><span class="text-success fw-bold">)</span>
                    </p>
                </div>
            </section>
        @endsection
