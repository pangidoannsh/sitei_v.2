...
<body>
        ...
        <table width="100%" style="text-align:center; margin-top:0px;">
            <tr>
                <td style="font-size:12pt;text-decoration: underline;">
                    <strong>FORM NILAI PENGUJI SEMINAR PROPOSAL SKRIPSI</strong> </td>
            </tr>
        </table>
    ...
    <table width="100%" style="font-family: Arial, sans-serif; margin-top:20px; line-height: 1.5">
        ...
        <tr>
            ...
            <td>:</td>
            <td width="70%">{{ $penjadwalan->revisi_proposal != null ? $penjadwalan->revisi_proposal : $penjadwalan->judul_proposal }}</td>
        </tr>
        <tr>
    ...
    <table class="tablesti5" width="100%" style="margin-top:-10px; font-family: Arial, sans-serif; line-height: 1.5">
        <tr>
        ...
        <tr class="text2">
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. &nbsp;&nbsp;&nbsp;Tingkat Penguasaan Materi (8)</td>
            <td>:</td>
        ...
        <tr class="text2">
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;9. &nbsp;&nbsp;&nbsp;Sumbangan Pemikiran Terhadap Ilmu Pengetahuan Dan Terapannya (6)</td>
            <td>:</td>
    ...
    <table class="tablesti5_1" width="90%">
        <tr>
        <td><hr style="margin: 1px; width:600px; border: 1px solid black"></td>
        <td>&#43;</td>
        </tr>
    </table>
