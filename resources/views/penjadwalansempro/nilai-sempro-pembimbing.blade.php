...
<body>
        ...
        <table width="100%" style="text-align:center; margin-top:0px;">
            <tr>
                <td style="font-size:12pt;text-decoration: underline;">
                    <strong>FORM NILAI PEMBIMBING SEMINAR PROPOSAL SKRIPSI</strong> </td>
            </tr>
        </table>
    ...
    <table class="tablesti6" width="95%" style="font-family: Arial, sans-serif; line-height: 1.5">
        ...
        <tr class="text3">
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. &nbsp;&nbsp;&nbsp;Penguasaan Dasar Teori (9)</td>
            <td>:</td>
            <td>{{$penilaianpembimbing->penguasaan_dasar_teori}}</td>
        </tr>

        <tr class="text2">
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. &nbsp;&nbsp;&nbsp;Tingkat Penguasaan Materi (9)</td>
            <td>:</td>
        ...
        <tr class="text2">
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5. &nbsp;&nbsp;&nbsp;Sikap dan Kepribadian Selama Bimbingan (9)</td>
            <td>:</td>
