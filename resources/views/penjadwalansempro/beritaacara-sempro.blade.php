...
<body>
        ...
        <table width="100%" style="text-align:center; margin-top:0px;">
            <tr>
                <td style="font-size:12pt;text-decoration: underline;">
                    <strong>BERITA ACARA SEMINAR PROPOSAL SKRIPSI</strong> </td>
            </tr>
        </table>
    ...
    <table class="tablesti7_4" width="81.5%" style="font-family: Arial, sans-serif; line-height: 1.5">
        ...
        <td><b>TOTAL NILAI PEMBIMBING + PENGUJI</b></td>
            <td>: &nbsp; @if ($nilaipenguji1 == '' && $nilaipenguji2 == '' && $nilaipenguji3 == '' && $nilaipembimbing1 =='' && $nilaipembimbing2 == '')
                                  -
                                  @else
                                        <?php
                                          $nilai_masuk=0;
    ...
    <table width="100%" style="font-family: Arial, sans-serif; position: absolute; margin-top: 50px;">
        <tr>
