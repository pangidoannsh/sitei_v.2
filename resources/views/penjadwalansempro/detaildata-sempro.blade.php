...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Detail Data Sempro</title>
        <!-- Fonts -->
                ...
                <div class="d-flex flex-column min-vh-100 justify-content-center align-items-center">
                    <div class="card text-center ">
                        ...
                        <div class="card-body">
                            ...
                            Judul Proposal : <strong>{{ $penjadwalan->revisi_proposal != null ? $penjadwalan->revisi_proposal : $penjadwalan->judul_proposal }}</strong><br>
                            ...
                            @endif
                            <br>
                            Tanggal Seminar : <strong>{{Carbon::parse($penjadwalan->tanggal)->translatedFormat('l, d F Y')}}</strong>
                        </div>
