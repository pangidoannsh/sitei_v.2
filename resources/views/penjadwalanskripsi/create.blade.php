...
@section('title')
    SITEI | Tambah Jadwal Sidang Skripsi
@endsection

@section('sub-title')
    Tambah Jadwal Sidang Skripsi
@endsection
            ...
            <div class="row">
                <div class="col">
                    <div class="mb-3 field">
                        ...
                        <select name="mahasiswa_nim" id="mhs"
                            class="form-select @error('mahasiswa_nim') is-invalid @enderror">
                            <option value="">-Pilih-</option>
                            @foreach ($mahasiswas as $mhs)
                                <option value="{{ $mhs->nim }}"
                                    {{ old('mahasiswa_nim') == $mhs->nim ? 'selected' : null }}>{{ $mhs->nama }}</option>
                            @endforeach
                        </select>
                        @error('mahasiswa_nim')
                ...
                <div class="col-md">
                    ...
                    <div class="mb-3 field">
                        ...
                        <select name="pembimbingsatu_nip" id="pembimbing1"
                            class="form-select @error('pembimbingsatu_nip') is-invalid @enderror">
                            <option value="">-Pilih-</option>
                            @foreach ($dosens as $dosen)
                                <option value="{{ $dosen->nip }}"
                                    {{ old('pembimbingsatu_nip') == $dosen->nip ? 'selected' : null }}>{{ $dosen->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3 field">
                        ...
                        <select name="pembimbingdua_nip" id="pembimbing2"
                            class="form-select @error('pembimbingdua_nip') is-invalid @enderror">
                            <option value="">-Pilih-</option>
                            @foreach ($dosens as $dosen)
                                <option value="{{ $dosen->nip }}"
                                    {{ old('pembimbingdua_nip') == $dosen->nip ? 'selected' : null }}>{{ $dosen->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3 field">
                        ...
                        <select name="pengujisatu_nip" id="penguji1"
                            ...
                            @foreach ($dosens as $dosen)
                                <option value="{{ $dosen->nip }}"
                                    {{ old('pengujisatu_nip') == $dosen->nip ? 'selected' : null }}>{{ $dosen->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3 field">
                        ...
                        <select name="pengujidua_nip" id="penguji2"
                            ...
                            @foreach ($dosens as $dosen)
                                <option value="{{ $dosen->nip }}"
                                    {{ old('pengujidua_nip') == $dosen->nip ? 'selected' : null }}>{{ $dosen->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3 field">
                        ...
                        <select name="pengujitiga_nip" id="penguji3"
                            ...
                            @foreach ($dosens as $dosen)
                                <option value="{{ $dosen->nip }}"
                                    {{ old('pengujitiga_nip') == $dosen->nip ? 'selected' : null }}>{{ $dosen->nama }}
                                </option>
                            @endforeach
                        </select>
