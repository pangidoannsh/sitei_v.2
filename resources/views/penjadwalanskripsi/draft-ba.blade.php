...
<body>
    <div class="isi">
                ...
                <table width="100%" style="font-family: Arial, sans-serif; margin-top:-15px;">
                    <tr class="text2">
                        <td>-&nbsp;<strong>LULUS</strong> dengan nilai angka
                            ...
                            diberikan waktu hingga tanggal {{ Carbon::parse($nextMonth)->translatedFormat('d F Y') }}
                ...
                <td class="text" style="text-align: left;">
                    @if ($penjadwalan->mahasiswa->prodi->id == 1)
                        <div class="container">
                            ...
                            <br><br><br><br>
                            <strong style="text-decoration: underline;">Firdaus, ST., MT</strong><br>NIP.
                            197705102005011002
                        </div>
                    @elseif ($penjadwalan->mahasiswa->prodi->id == 2)
                        <div class="container">
                            ...
                            <br><br><br><br>
                            <strong style="text-decoration: underline;">Rahmat Rizal Andhi, ST., MT</strong><br>NIP.
                            198312032019031006
                        </div>
                    @else
                        <div class="container">
                            ...
                            <br><br><br><br>
                            <strong style="text-decoration: underline;">Edi Susilo, S.Pd., M.Kom.,
                                M.Eng</strong><br>NIP. 199110292019031010
                        </div>
                    @endif
                    <br>
                </td>
                ...
                <td class="text" style="text-align: left;">
                    @if ($penjadwalan->mahasiswa->prodi->id == 1)
                        <div class="container">
                            ...
                            <br><br><br><br>
                            <strong style="text-decoration: underline;">Amir Hamzah, ST., MT</strong><br>NIP.
                            197507052002121003
                        </div>
                    @elseif ($penjadwalan->mahasiswa->prodi->id == 2)
                        <div class="container">
                            ...
                            <br><br><br><br>
                            <strong style="text-decoration: underline;">Yusnita Rahayu, ST, M.Eng,
                                Ph.D</strong><br>NIP. 197511042005012001
                        </div>
                    @else
                        <div class="container">
                            ...
                            <br><br><br><br>
                            <strong style="text-decoration: underline;">Dr. Feri Candra, ST., MT</strong><br>NIP.
                            197404282002121003
                        </div>
                    @endif
                    <br>
        ...
        <table width="100%">
            ...
            <tr>
                <td style="font-size:10px;">Form ini dikembalikan ke koordinator skripsi melalui staf administrasi
                    disertai form STI-13 dan STI-14.</td>
            </tr>
        </table>
