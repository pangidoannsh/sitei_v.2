    ...
    <div>
        ...
        <div class="mb-3 field">
            ...
            @if(auth()->user()->role_id == 4)                                                          
                <label class="form-label">Judul Skripsi</label>
            @endif
            <input type="text" name="judul_skripsi" class="form-control @error('judul_skripsi') is-invalid @enderror" value="{{ old('judul_skripsi', $skripsi->judul_skripsi) }}" readonly>
            @error('judul_skripsi')
              <div class="invalid-feedback">
                  {{$message}}
              </div>
    ...
    <div class="col">
      <div class="mb-3 field">
        ...
        <div class="mb-3 field">
            ...
            <select type="text" name="lokasi" id="lokasi2" class="form-select @error('lokasi') is-invalid @enderror" value="{{ old('lokasi', $skripsi->lokasi) }}">
