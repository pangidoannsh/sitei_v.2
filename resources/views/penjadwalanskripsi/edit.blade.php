        ...
        <div class="container">
            ...
            <div class="mb-3 field">
                ...
                <script src="http://code.jquery.com/ui/1.9.2/jquery-ui.js"></script>       
                    ...
                    <input id ="ciek" type="text" onchange="teshari()" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror" value="{{ old('tanggal', $skripsi->tanggal) }}" disabled>
            ...
            <div class="mb-3 field">
                ...
                <option value="">-Belum Dipilih-</option>
                    @foreach ($jamsels as $jamsel)
                        <option value="{{$jamsel->jam_tersedia}}" {{old('waktu', $skripsi->waktu) == $jamsel->jam_tersedia ? 'selected' : null}}>{{$jamsel->jam_tersedia}}</option>
                    @endforeach
                </select>
                ...
                <option value="">-Belum Dipilih-</option>
                    @foreach ($jamkams as $jamkam)
                        <option value="{{$jamkam->jam_tersedia}}" {{old('waktu', $skripsi->waktu) == $jamkam->jam_tersedia ? 'selected' : null}}>{{$jamkam->jam_tersedia}}</option>
                    @endforeach
                </select>
                @error('waktu')
                <div class="invalid-feedback">
            ...
            <div class="mb-3 field">
                ...
                <select type="text" name="lokasi" id="lokasi2" class="form-control @error('lokasi') is-invalid @enderror" value="{{ old('lokasi', $skripsi->lokasi) }}" disabled>
                <option value="">-Belum Dipilih-</option>
            ...
            <button type="submit" class="btn btn-success float-right mt-3">Ubah</button>
        </div>
</form>
