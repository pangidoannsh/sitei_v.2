...
<body>
    ...
    <table width="100%" style="font-family: Arial, sans-serif; margin-top:-15px; line-height: 1.5">
        ...
        <tr>
            <td>Judul Skripsi</td>
            <td width="100%">: &nbsp; {{ $penjadwalan->revisi_skripsi != null ? $penjadwalan->revisi_skripsi : $penjadwalan->judul_skripsi }} </td>
        </tr>
    ...
    <table class="tablesti15" width="100%" style="font-family: Arial, sans-serif; line-height: 1.5; margin-top:3px;">
        <tr>
    ...
    <table class="tablesti15_6" width="84%" style="font-family: Arial, sans-serif; line-height: 1.5; margin-top:1px;">
        <tr>
    ...
    <table class="tablesti15_6" width="85%" style="font-family: Arial, sans-serif; line-height: 1.5; margin-top:1px;">
        <tr>
