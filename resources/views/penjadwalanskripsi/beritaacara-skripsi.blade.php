...
<body>
    <div class="isi">
        ...
        <table width="100%" style="text-align:center; margin-top:0px;">
            <tr>
                <td style="font-size:12pt;text-decoration: underline;">
                    <strong>BERITA ACARA SIDANG SKRIPSI</strong>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="font-family: Arial, sans-serif; margin-top:-15px; line-height: 1.5">
            ...
            <tr>
                <td>NIM</td>
                <td>: &nbsp; {{ $penjadwalan->mahasiswa->nim }} </td>
            </tr>
            ...
            <tr>
                <td>Tanggal</td>
                <td>: &nbsp; {{ Carbon::parse($penjadwalan->tanggal)->translatedFormat('l, d F Y') }} </td>
            </tr>

            <tr>
                <td>Ruang / Pukul</td>
                <td>: &nbsp; {{ $penjadwalan->lokasi }}, {{ $penjadwalan->waktu }} </td>
            </tr>
                ...
                <table width="100%" style="font-family: Arial, sans-serif; ">
                    <tr class="text2">
                        <td>-&nbsp;<strong>LULUS</strong> dengan nilai angka
                            ...
                            diberikan waktu hingga tanggal
                            {{ Carbon::parse($penjadwalan->tanggal)->modify('+30 days')->translatedFormat('d F Y') }}
                            untuk menyempurnakan Skripsi. Adapun hasil revisi skripsi wajib dilaporkan kepada :
                            Pembimbing ( ), Penguji ( ). Apabila tidak menyelesaikan revisi skripsi sampai batas waktu
                            yang ditentukan, maka hasil sidang ini dinyatakan BATAL dan mahasiswa yang bersangkutan
                            harus melakukan sidang ulang.
                        </td>
                    </tr>
                </table>
                ...
                <table width="100%" style="font-family: Arial, sans-serif; margin-top:-15px;">
                    <tr class="text2">
                        <td>-&nbsp;<strong>LULUS</strong> dengan nilai angka
                            ...
                            dan huruf mutu
                            <strong>()</strong>
                            diberikan waktu hingga tanggal .................. untuk menyempurnakan Skripsi. Adapun hasil
                            revisi skripsi wajib dilaporkan kepada : Pembimbing ( ), Penguji ( ). Apabila tidak
                            menyelesaikan revisi skripsi sampai batas waktu yang ditentukan, maka hasil sidang ini
        ...
        <table width="100%" class="table1"
            style="font-family: Arial, sans-serif; margin-top:-8px; text-align:center;">
            <tr>
                ...
                <td class="text" style="text-align: left;">
                    @if ($penjadwalan->mahasiswa->prodi->id == 1)
                        <div class="container">
                            ...
                            <br><br><br><br>
                            <strong style="text-decoration: underline;">{{ $koordinator1->nama }}</strong><br>NIP.
                            {{ $koordinator1->nip }}
                        </div>
                    @elseif ($penjadwalan->mahasiswa->prodi->id == 2)
                        <div class="container">
                            ...
                            <br><br><br><br>
                            <strong style="text-decoration: underline;">{{ $koordinator2->nama }}</strong><br>NIP.
                            {{ $koordinator2->nip }}
                        </div>
                    @else
                        <div class="container">
                            ...
                            <br><br><br><br>
                            <strong style="text-decoration: underline;">{{ $koordinator3->nama }}</strong><br>NIP.
                            {{ $koordinator3->nip }}
                        </div>
                    @endif
                    <br>
        ...
        <table width="100%" style="font-family: Arial, sans-serif; position: absolute; margin-top:-15px;">
            <tr>
        ...
        <table width="100%" style="margin-top:0px;">
            ...
            <table width="550px" style="text-align:center">
                <tr>
                    <td>
                        <hr style="margin: 1px; border: 2px solid black">
                        <hr style="margin: 1px; border: 1px solid black">
            ...
            <table width="620%" style="text-align: right; margin-top:5px;">
                <tr>
                    <td style="font-size:12pt;">
                        @if ($penjadwalan->mahasiswa->prodi->id == 1)
                            <strong style="border:1px solid #000; padding:4px">STE-15</strong>
        ...
        <table class="tablesti15" width="100%"
            style="font-family: Arial, sans-serif; line-height: 1.5; margin-top:3px;">
            <tr>
        ...
        <table class="tablesti15_6" width="84%"
            style="font-family: Arial, sans-serif; line-height: 1.5; margin-top:1px;">
            <tr>
        ...
        <table class="tablesti15_6" width="85%"
            style="font-family: Arial, sans-serif; line-height: 1.5; margin-top:1px;">
            <tr>
        ...
        <table class="tablesti15_4" width="83%" style="font-family: Arial, sans-serif; line-height: 1.5">
            <tr>
