...
<html>
<head>
    <title>STI-14 Form Nilai Penguji Sidang Skripsi</title>
    @php
        use Carbon\Carbon;
...
<body>
        ...
        <table width="100%" style="text-align:center; margin-top:0px;">
            <tr>
                <td style="font-size:12pt; text-decoration: underline;">
                    <strong>FORM NILAI PENGUJI SIDANG SKRIPSI</strong> </td>
            </tr>
        </table>
        ...
        <table width="100%" style="text-align: right; margin-top:-40px;">
            <tr>
                <td style="font-size:12pt;">
                    @if ($penjadwalan->mahasiswa->prodi->id == 1)
                        <strong style="border:1px solid #000; padding:4px">STE-14</strong>
                    @elseif ($penjadwalan->mahasiswa->prodi->id == 2)
                        <strong style="border:1px solid #000; padding:4px">STE-14</strong>
                    @else
                        <strong style="border:1px solid #000; padding:4px">STI-14</strong>
                    @endif
                </td>
            </tr>
        </table>
    ...
    <table width="100%" style="font-family: Arial, sans-serif; margin-top:-13px; margin-left:31%;">
        <tr>
    ...
    <table class="tablesti14" width="95%" style="font-family: Arial, sans-serif; line-height: 1.5; margin-top:5px ">
        <tr>
            <td>Aspek Penilaian</td>
        </tr>

        <tr class="text3">
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. &nbsp;&nbsp;&nbsp;Presentasi (2)</td>
            <td>:</td>
            <td>{{$penilaianpenguji->presentasi}}</td>
        </tr>

        <tr class="text2">
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. &nbsp;&nbsp;&nbsp;Tingkat Penguasaan Materi (3)</td>
            <td>:</td>
        ...
        <tr class="text2">
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;12. &nbsp;&nbsp;&nbsp;Pembahasan (4)</td>
            <td>:</td>
            <td>{{$penilaianpenguji->pembahasan}}</td>
        </tr>

        <tr class="text2">
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;13. &nbsp;&nbsp;&nbsp;Kesimpulan (3)</td>
            <td>:</td>
        ...
        <tr class="text2">
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;15. &nbsp;&nbsp;&nbsp;Sumbangan Pemikiran Terhadap Ilmu Pengetahuan Dan Terapannya (3)</td>
            <td>:</td>
            <td>{{$penilaianpenguji->sumbangan_pemikiran}}</td>
        </tr>
    </table>

    <table class="tablesti14_1" width="90%">
        <tr>
        <td><hr style="margin:1px; width:540px; border: 1px solid black"></td>
        <td>&#43;</td>
        </tr>
    </table>

    <table class="tablesti14_2" width="85.5%" style="font-family: Arial, sans-serif; line-height: 1.5">
        <tr>
            <td><b>Total Nilai Penguji (maks: 45%)</b></td>
            <td>:</td>
    ...
    <table width="100%" style="font-family: Arial, sans-serif; position: absolute; margin-top:20px;">
        <tr>
