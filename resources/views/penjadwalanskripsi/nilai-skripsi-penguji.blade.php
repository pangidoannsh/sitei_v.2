...
<body>
    <div class="isi">
        ...
        <table width="100%" style="text-align:center; margin-top:0px;">
            <tr>
                <td style="font-size:12pt; text-decoration: underline;">
                    <strong>FORM NILAI PENGUJI SIDANG SKRIPSI</strong>
                </td>
            </tr>
        </table>
        ...
        <table class="tablesti14" width="95%"
            style="font-family: Arial, sans-serif; line-height: 1.5; margin-top:5px ">
            <tr>
            ...
            <tr class="text2">
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;15. &nbsp;&nbsp;&nbsp;Sumbangan
                    Pemikiran Terhadap Ilmu Pengetahuan Dan Terapannya (3)</td>
                <td>:</td>
