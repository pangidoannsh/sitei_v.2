...
<ol class="breadcrumb col-lg-12">
  ...
  <li class="breadcrumb-item"><a class="breadcrumb-item" href="/persetujuan-koordinator">Persetujuan Seminar (<span id=""></span>)</a></li> -->
  <span class="px-2">|</span>
  <li class="breadcrumb-item"><a class="breadcrumb-item active fw-bold text-success" href="/riwayat-koordinator">Riwayat Persetujuan (<span>{{ $jml_riwayat_persetujuan_seminar }}</span>)</a></li>  
</ol>
