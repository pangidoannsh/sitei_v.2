...
@section('content')
    <ol class="breadcrumb col-lg-12">
        ...
        <li class="breadcrumb-item"><a class="breadcrumb-item active" href="riwayat-penilaian-skripsi">Riwayat Penilaian</a>
        </li>
    </ol>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if ($skripsi->pengujisatu_nip == auth()->user()->nip)
                            <a href="/penilaian-skripsi/cek-nilai/{{ $skripsi->id }}" class="badge bg-primary">Berita
                                Acara</a>
                        @endif
                    </td>
                </tr>
