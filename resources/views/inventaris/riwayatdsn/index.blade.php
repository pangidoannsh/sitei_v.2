...
<div class="container card p-4">
  ...
  <ol class="breadcrumb col-lg-12">   
    ...
    <li class="breadcrumb-item"><a class="breadcrumb-item" href="{{ route('peminjamandsn') }}">Daftar Pinjam ({{ $jumlah_pinjaman }})</a></li>
  
    <span class="px-2">|</span>      
    <li class="breadcrumb-item"><a class="breadcrumb-item active fw-bold text-black" href="{{ route('riwayatdsn') }}">Riwayat Pinjam ({{ $jumlah_riwayat }})</a></li>  
