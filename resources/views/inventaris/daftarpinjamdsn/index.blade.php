...
@section('content')
    ...
    <a href="{{ route('formusulandosen') }}"> <button class="mb-4 w-85 btn btn-success rounded border" type="button">+ Usulan
            Peminjaman</button></a>
    ...
    <li class="breadcrumb-item"><a href="/riwayat-penjadwalan">Riwayat Penjadwalan</a></li> --}}
            ...
            <li class="breadcrumb-item"><a class="breadcrumb-item active fw-bold text-success"
                    href="{{ route('peminjamandsn') }}">Daftar Pinjam ({{ $jumlah_pinjaman }})</a></li>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if ($pinjaman->status == 'Usulan')
                                <a href="{{ url('inventaris/edit-dosen/' . $pinjaman->id) }}"
                                ...
                                <a href="{{ url('inventaris/delete-dosen/' . $pinjaman->id) }}"
