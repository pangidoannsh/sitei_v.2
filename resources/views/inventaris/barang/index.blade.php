...
@section('content')
    ...
    <div class="container card p-4">
        ...
        <ol class="breadcrumb col-lg-12">
            <li class="breadcrumb-item"><a href="{{ route('peminjamanadm') }}">Daftar Pinjaman ({{ $jumlah_pinjaman }})</a>
            </li>
            <span class="px-2">|</span>
            <li class="breadcrumb-item"><a class="breadcrumb-item" href="{{ route('riwayatadm') }}">Riwayat Pinjaman
                    ({{ $jumlah_riwayat }})</a></li>
            <span class="px-2">|</span>
            <li class="breadcrumb-item active fw-bold"><a class="text-success" href="{{ route('stok') }}">Daftar Barang
                    ({{ $jumlah_barang }})</a></li>
                ...
                @foreach ($barang as $barang)
                    <tr>
                        ...
                        <td class="text-center">
                            <a type="button" href="{{ route('editbarang', $barang->id) }}"
