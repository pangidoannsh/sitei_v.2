...
<div class="card">
    ...
    <div class="card-body">
      ...
      <div class="col-sm-5">
          <form action="{{ url('/inventaris/usulan-dosen') }}" method="POST" class="mx-auto" id="input-form">
            @csrf
            ...
            <div class="form-group row justify-content-center">
              ...
              <div class="col-sm-7">
                <input type="lokasi" class="form-control" id="inputEmail3" placeholder="Lokasi" name="ruangan" required>
              </div>
            </div>
            <div class="form-group row justify-content-center">
          ...
          <div class="form-group row justify-content-center">
              <button type="submit" class="col-sm-2 btn px-3 py-2 mt-3 btn-success justify-content-center">Usulkan</button>
          </div>
        </form>
    </div>
  </div>
