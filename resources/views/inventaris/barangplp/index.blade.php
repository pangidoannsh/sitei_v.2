...
<div class="container card p-4">
  ...
  <ol class="breadcrumb col-lg-12">
    ...
    <span class="px-2">|</span>   
    <li class="breadcrumb-item active fw-bold text-black"><a  href="{{ route('stokplp') }}">Daftar Barang ({{ $jumlah_barang }})</a></li>  
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="text-center">
            <a type="button" href="{{ route('editbarangplp', $barang->id) }}" class="badge p-2 bg-warning border-0" >
