    ...
    <div class="container card p-4">
        ...
        <ol class="breadcrumb col-lg-12">
            ...
            <li class="breadcrumb-item"><a class="breadcrumb-item " href="{{ route('riwayatplp') }}">Riwayat Pinjaman
                    ({{ $jumlah_riwayat }})</a></li>
            <span class="px-2">|</span>
            <li class="breadcrumb-item"><a class="breadcrumb-item " href="{{ route('stokplp') }}">Daftar Barang
                    ({{ $jumlah_barang }})</a></li>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @if ($pinjaman->status == 'Usulan')
                                <a href="{{ url('inventaris/tolak-plp/' . $pinjaman->id) }}"
                                ...
                                <a href="{{ url('inventaris/setuju-plp/' . $pinjaman->id) }}"
                            ...
                            @if ($pinjaman->status == 'Disetujui')
                                ...
                                <a href="{{ url('inventaris/kembali-plp/' . $pinjaman->id) }}"
                                    class="badge bg-success rounded border-0"><i><svg xmlns="http://www.w3.org/2000/svg"
                                            height="1em"
                                            viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                            <style>
