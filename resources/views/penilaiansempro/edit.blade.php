            ...
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                    <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel"
                        ...
                        <form action="/penilaian-sempro-pembimbing/edit/{{ $sempro->penjadwalan_sempro_id }}" class="simpan-nilai-pembimbing" method="POST">
                            @method('put')
                            @csrf
    ...
    @if (auth()->user()->nip == $sempro->penjadwalan_sempro->pengujisatu_nip ||
        ...
        @if (auth()->user()->nip == $sempro->penjadwalan_sempro->pengujisatu_nip)
            ...
            <div class="tab-pane fade" id="custom-tabs-one-form" role="tabpanel"
                ...
                <form action="/revisi-proposal/create/{{ $sempro->penjadwalan_sempro->id }}" class="simpan-revisi" method="POST">
                    @csrf
                    <div class="mb-3 gridratakiri">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            @elseif($nilaipenguji2 == null && $sempro->penjadwalan_sempro->pengujidua !== null)
                                ...
                                @elseif($nilaipenguji3 == null && $sempro->penjadwalan_sempro->pengujitiga !== null)
                                <a href="#ModalApprove20" data-toggle="modal"
                                    class="btn mt-5 btn-lg btn-danger float-right">Selesai Seminar</a>
                                <div class="modal fade"id="ModalApprove20">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <div class="container px-5 pt-5 pb-2 text-center">
                            ...
                            @elseif($sempro->penjadwalan_sempro->status_seminar == 1)
