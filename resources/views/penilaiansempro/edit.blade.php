...
@section('content')
    ...
    <div class="container">
        <div class="row rounded shadow-sm">
            <div class="col-lg-4 col-md-12 bg-white rounded-start px-4 py-3 mb-2">
                ...
                <p class="card-text text-start">{{ $sempro->penjadwalan_sempro->mahasiswa->konsentrasi->nama_konsentrasi }}
                </p>
        ...
        <div class="row rounded shadow-sm">
            <div class="col-lg-6 col-md-12 bg-white rounded-start px-4 py-3 mb-2">
                ...
                <p class="card-text text-start">
                    {{ $sempro->penjadwalan_sempro->revisi_proposal != null ? $sempro->penjadwalan_sempro->revisi_proposal : $sempro->penjadwalan_sempro->judul_proposal }}
                </p>
    ...
    @endfor
              ...
              <br> -->
                                    ...
                                    <input type="radio"
                                        ...
                                        name="tingkat_penguasaan_materi" id="tingkat_penguasaan_materi1" value="1.8"
                                        onclick="hasil()"
                                    ...
                                    <input type="radio"
                                        class="btn-check @error('tingkat_penguasaan_materi') is-invalid @enderror"
                                        name="tingkat_penguasaan_materi" id="tingkat_penguasaan_materi2" value="3.6"
                                        onclick="hasil()"
                                    ...
                                    <input type="radio"
                                        class="btn-check @error('tingkat_penguasaan_materi') is-invalid @enderror"
                                        name="tingkat_penguasaan_materi" id="tingkat_penguasaan_materi3" value="5.4"
                                        onclick="hasil()"
                                    ...
                                    <input type="radio"
                                        class="btn-check @error('tingkat_penguasaan_materi') is-invalid @enderror"
                                        name="tingkat_penguasaan_materi" id="tingkat_penguasaan_materi4" value="7.2"
                                        onclick="hasil()"
                                    ...
                                    <input type="radio"
                                        class="btn-check @error('tingkat_penguasaan_materi') is-invalid @enderror"
                                        name="tingkat_penguasaan_materi" id="tingkat_penguasaan_materi5" value="9"
                                        onclick="hasil()"
    ...
    @endfor
                  ...
                  <br> -->
                            ...
                            <div class="mb-3 gridratakiri">
                                <label for="hasil_dan_pembahasan" class="col-form-label">5). Sikap dan Kepribadian Ketika
                                    Bimbingan</label>
    ...
    @endfor
             ...
             <br> -->
                                    ...
                                    <input type="radio"
                                        class="btn-check @error('tingkat_penguasaan_materi') is-invalid @enderror"
                                        name="tingkat_penguasaan_materi" id="tingkat_penguasaan_materi1" value="1.6"
                                        onclick="total()"
                                    ...
                                    <input type="radio"
                                        class="btn-check @error('tingkat_penguasaan_materi') is-invalid @enderror"
                                        name="tingkat_penguasaan_materi" id="tingkat_penguasaan_materi2" value="3.2"
                                        onclick="total()"
                                    ...
                                    <input type="radio"
                                        class="btn-check @error('tingkat_penguasaan_materi') is-invalid @enderror"
                                        name="tingkat_penguasaan_materi" id="tingkat_penguasaan_materi3" value="4.8"
                                        onclick="total()"
                                    ...
                                    <input type="radio"
                                        class="btn-check @error('tingkat_penguasaan_materi') is-invalid @enderror"
                                        name="tingkat_penguasaan_materi" id="tingkat_penguasaan_materi4" value="6.4"
                                        onclick="total()"
                                    ...
                                    <input type="radio"
                                        class="btn-check @error('tingkat_penguasaan_materi') is-invalid @enderror"
                                        name="tingkat_penguasaan_materi" id="tingkat_penguasaan_materi5" value="8"
                                        onclick="total()"
    ...
    @endfor
             ...
             <br> -->
                                    ...
                                    <input type="radio"
                                        class="btn-check @error('tinjauan_pustaka') is-invalid @enderror"
                                        name="tinjauan_pustaka" id="tinjauan_pustaka1" value="1.4" onclick="total()"
                                    ...
                                    <input type="radio"
                                        class="btn-check @error('tinjauan_pustaka') is-invalid @enderror"
                                        name="tinjauan_pustaka" id="tinjauan_pustaka2" value="2.8" onclick="total()"
                                    ...
                                    <input type="radio"
                                        class="btn-check @error('tinjauan_pustaka') is-invalid @enderror"
                                        name="tinjauan_pustaka" id="tinjauan_pustaka3" value="4.2" onclick="total()"
                                        {{ old('tinjauan_pustaka', $sempro->tinjauan_pustaka) == '4.2' ? 'checked' : null }}>
                                    <label class="btn tombol btn-info fw-normal " for="tinjauan_pustaka3">Biasa</label>

                                    <input type="radio"
                                        class="btn-check @error('tinjauan_pustaka') is-invalid @enderror"
                                        name="tinjauan_pustaka" id="tinjauan_pustaka4" value="5.6" onclick="total()"
                                        {{ old('tinjauan_pustaka', $sempro->tinjauan_pustaka) == '5.6' ? 'checked' : null }}>
                                    <label class="btn tombol btn-primary fw-normal " for="tinjauan_pustaka4">Baik</label>

                                    <input type="radio"
                                        class="btn-check @error('tinjauan_pustaka') is-invalid @enderror"
                                        name="tinjauan_pustaka" id="tinjauan_pustaka5" value="7" onclick="total()"
    ...
    @endfor
                ...
                <br> -->
                            ...
                            <div class="mb-3 gridratakiri">
                                <label for="sumbangan_pemikiran" class="col-form-label">9). Sumbangan Pemikiran Terhadap
                                    Ilmu Pengetahuan</label>
                ...
                <form action="/revisi-proposal/create/{{ $sempro->penjadwalan_sempro->id }}" method="POST">
                    ...
                    <div class="mb-3 gridratakiri">
                        ...
                        <input type="text" class="form-control"
                            value="{{ $sempro->penjadwalan_sempro->judul_proposal }}" readonly>
                    </div>
                    <div class="mb-3 gridratakiri">
                ...
                <div>
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            @if ($total_nilai <= 60)
                                <form action="/catatansempro/create/{{ $sempro->penjadwalan_sempro->id }}"
                                    method="POST">
                                    @csrf
                                    <div class="mb-3 gridratakiri">
                                    ...
                                    <div class="mb-3 gridratakiri">
                                        ...
                                        <input type="text" name="catatan2" class="form-control"
                                            value="{{ $sempro->penjadwalan_sempro->catatan2 != null ? $sempro->penjadwalan_sempro->catatan2 : '' }}">
                                    </div>
                                    <div class="mb-3 gridratakiri">
                                        <label class="form-label">Catatan 3</label>
                                        <input type="text" name="catatan3" class="form-control"
                                            value="{{ $sempro->penjadwalan_sempro->catatan3 != null ? $sempro->penjadwalan_sempro->catatan3 : '' }}">
                                    </div>
                                    <div>
                                        <button type="submit" class="btn btn-success mb-5 float-left">+
                                            Catatan</button>
                                    </div>
                                </form>
                            @else
                                ...
                                <div class="modal fade"id="ModalApprove6">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <div class="container px-5 pt-5 pb-2 text-center">
                                                    <h1 class="text-success"><i class="fas fa-check-circle fa-lg"></i>
                                                    </h1>
                                                ...
                                                <div class="modal-body">
                                                    <div class="container px-5 pt-5 pb-2">
                                                        ...
                                                        <div class="row text-center">
                                                            ...
                                                            <div class="col-2">
                                                                <form
                                                                    action="/penilaian-sempro/gagal/{{ $penjadwalan->id }}"
                                                                    method="POST">
                                                                    @method('put')
                                                                    @csrf
                                                                    <button type="submit"
                                                ...
                                                <div class="modal-body">
                                                    <div class="container px-5 pt-5 pb-2">
                                                        ...
                                                        <div class="row text-center">
                                                            ...
                                                            <div class="col-2">
                                                                <form
                                                                    action="/penilaian-sempro/approve/{{ $penjadwalan->id }}"
                                                                    method="POST">
                                                                    @method('put')
                                                                    @csrf
