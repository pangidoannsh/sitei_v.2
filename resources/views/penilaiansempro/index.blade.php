                    ...
                    <td>
                        @if ($sempro->penilaian(Auth::user()->nip, $sempro->id) == false)
                            @if ($sempro->status_seminar == '0')
                                <a href="/penilaian-sempro/create/{{ $sempro->id }}"
                                    class="badge bg-primary"style="border-radius:20px; padding:7px;"> Input Nilai<a>
                                    @else
                                        <span class="badge bg-danger"style="border-radius:20px; padding:7px;">Belum
                                            Dimulai</span>
                            @endif
                        @else
                            <a href="/penilaian-sempro/edit/{{ $sempro->id }}" class="badge bg-warning"
                                style="border-radius:20px; padding:7px;"> Edit Nilai<a>
                        @endif
                    </td>
                </tr>
            @endforeach
                ...
                <tr>
                    ...
                    <td>
                        @if ($skripsi->penilaian(Auth::user()->nip, $skripsi->id) == false)
                            ...
                            @endif
                        @else
                            <a href="/penilaian-skripsi/edit/{{ $skripsi->id }}" class="badge bg-warning"
                                style="border-radius:20px; padding:7px;"> Edit Nilai<a>
                        @endif
                    </td>
                </tr>
