                                ...
                                <div class="col mb-4">
                                    ...
                                    <div class="col float-center pt-3">
                                        <a class="bg-success text-white p-2 rounded-circle fs-5" formtarget="_blank"
                                            target="_blank" href="https://www.instagram.com/rahulilsa"><i
                                ...
                                <div class="col">
                                    <div class="row row-lg-cols-2 row-md-cols-1">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            ...
                                            <p class="text-muted">Merancang dan Mengembangkan Backend Website Sistem
                                                Penilaian Seminar Akademik</p>
                                        </div>
                                    </div>
                                </div>
