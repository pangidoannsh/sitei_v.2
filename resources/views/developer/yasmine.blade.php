                ...
                <div class="row  p-2">
                    ...
                    <div class="col-lg-4 shadow text-center rounded-start bg-success">
                        <div class="row text-white p-4 pt-4 row-cols-1">
                            <div class="col">
                                <img src="/assets/img/Yasmin.jpg" class="rounded-circle" alt="naldi" width="100">
                                <h6 class="mt-2 ">Yasminne R.A.S Vadri</h6>
                                ...
                                <div class="col mb-4">
                                    <div class="row row-lg-cols-2 row-md-cols-1">
                                        <div class="col">
                                            ...
                                            <p class="text-muted">2007110664</p>
                                        </div>
                                        <div class="col">
                                            <h6 class="fw-bold">Email</h6>
                                            <p class="text-muted">yasminnevdr@gmail.com</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="row row-lg-cols-2 row-md-cols-1">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            ...
                                            <p class="text-muted">Merancang Frontend Website Sistem Inventaris Perkuliahan
