...
<div class="container">
    <div class="text-center text-light mb-5 bg-dark">
    <h1 class="fw-bold p-3">Tentang Developer</h1>
    </div>
  <div class="row">
    ...
    <div class="col-8">
        ...
        <h4 class="fw-bold">Front End Developer pada Penilaian Seminar Akademik</h4>
