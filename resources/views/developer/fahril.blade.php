...
<div class="container p-5">
  ...
  <div class="col float-center pt-3">
      <a class="bg-success text-white p-2 rounded-circle fs-5" formtarget="_blank" target="_blank" href="https://www.instagram.com/fahrilhadii"><i class="fab fa-instagram"></i></a>
