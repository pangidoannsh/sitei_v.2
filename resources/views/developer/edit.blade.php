    ...
    @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama"
                            value="{{ old('nama', $dev->nama ?? '') }}" autofocus>
                        @error('nama')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label pb-0">NIM<span class="text-danger">*</span></label>
                        <input type="number" class="form-control" name="nim" value="{{ old('nim', $dev->nim ?? '') }}"
                            required>
                        @error('nim')
                            <div class="invalid-feedback">
                                {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="peran"
                            value="{{ old('peran', $dev->peran ?? '') }}" required>
                        @error('peran')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_aplikasi"
                            value="{{ old('nama_aplikasi', $dev->nama_aplikasi ?? '') }}" required>
                        @error('nama_aplikasi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="deskripsi_peran"
                            value="{{ old('deskripsi_peran', $dev->deskripsi_peran ?? '') }}" required>
