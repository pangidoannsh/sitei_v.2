    ...
    <div>
        <div class="container card p-4">
            <ol class="breadcrumb col-lg-12">
                <li><a href="/absensimahasiswa" class="px-1 fw-bold text-success">Absensi ({{ $total_absensi }})</a></li>
            ...
            <table class="table table-responsive-lg text-center table-bordered table-striped" style="width:100%"
                ...
                <thead class="table-dark">
                    <tr>
                        ...
                        <th class="text-center" scope="col">Jumlah Kehadiran</th>
                ...
                <tbody>
                    @foreach ($riwayatAbsensiGroupedFinal as $absensi)
                        <tr>
                            ...
                            <td>{{ $jumlah_kehadiran[$absensi->mata_kuliah] ?? '-' }}</td>
                            <td>
