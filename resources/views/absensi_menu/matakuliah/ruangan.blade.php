...
@section('content')
    ...
    <div class="container card p-4">
        ...
        <ol class="breadcrumb col-lg-12">
            ...
            <li><a href="/matakuliah" class="px-1">Mata Kuliah ({{ $count }})</a></li>
            <span class="px-2">|</span>
            <li><a href="{{ route('riwayat') }}" class="breadcrumb-item  px-1">Riwayat ({{ $countMatakuliah }})</a></li>
            <span class="px-2">|</span>
            <li><a href="{{ route('ruangan-absensi-admin') }}" class="breadcrumb-item  px-1 fw-bold text-success">Ruangan
                    ({{ $jumlah_ruangan }})</a></li>
        ...
        <div class="d-none d-md-flex justify-content-between mb-3 filter">
            <div class="d-flex align-items-center">
                <div class="dataTables_length input-group" style="width: max-content;">
                    <label class="pt-2 pr-2" for="lengthMenuRuanganMatakuliah">Tampilkan</label>
                    <select id="lengthMenuRuanganMatakuliah" class="custom-select custom-select-md rounded-3 py-1"
                        style="width: 55px;">
                ...
                <div class="input-group ml-3" style="width: max-content;">
                    <label class="pt-2 pr-2" for="semesterFilterHari">Hari</label>
                    <select id="semesterFilterHari" class="custom-select custom-select-md rounded-3 py-1 text-capitalize"
                        style="width: 83px;">
                        <option value="" selected>Semua</option>
            ...
            <div class="dataTables_filter input-group" style="width: max-content;">
                <label class="pt-2 pr-2" for="searchFilterRuanganMatakuliah">Cari</label>
                <input type="search" class="form-control form-control-md rounded-3 py-1" id="searchFilterRuanganMatakuliah"
                    placeholder="">
            </div>
        </div>
        ...
        <div class="d-flex flex-wrap justify-content-center gap-3 mb-3 filter d-block d-md-none">
            <div class="input-group mt-3" style="width: max-content;">
                <label class="pt-2 pr-2" for="ruanganFilterMobile">Ruangan</label>
                <select id="ruanganFilterMobile" class="custom-select custom-select-md rounded-3 py-1 text-capitalize"
                    style="width: 83px;">
                    <option value="" selected>Semua</option>
                    @foreach ($ruangan_list as $rgn)
                        <option value="{{ $rgn }}" class="text-capitalize">{{ $rgn }}</option>
            ...
            <div class="input-group mt-3" style="width: max-content;">
                <label class="pt-2 pr-2" for="hariFilterMobile">Hari</label>
                <select id="hariFilterMobile" class="custom-select custom-select-md rounded-3 py-1 text-capitalize"
                    style="width: 83px;">
                    <option value="" selected>Semua</option>
                    @foreach ($hari_list as $hr)
                        <option value="{{ $hr }}" class="text-capitalize">{{ $hr }}</option>
