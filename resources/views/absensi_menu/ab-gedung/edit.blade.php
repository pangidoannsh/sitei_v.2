                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="koordinat_latitude"
                                    class="form-control @error('koordinat_latitude') is-invalid @enderror"
                                    value="{{ old('nama_gedung', $gedung->koordinat_latitude) }}">
                        ...
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="koordinat_longitude"
                                    class="form-control @error('koordinat_longitude') is-invalid @enderror"
                                    value="{{ old('nama_gedung', $gedung->koordinat_longitude) }}">
