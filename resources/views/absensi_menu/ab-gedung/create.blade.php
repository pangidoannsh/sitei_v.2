                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-sm-7">
                                <input name="nama_gedung" class="form-control @error('nama_gedung') is-invalid @enderror"
                                    rows="2" placeholder="Gedung">{{ old('nama_gedung') }}</input>
                                @error('nama_gedung')
                        ...
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-sm-7">
                                <input name="koordinat_longitude"
                                    class="form-control @error('koordinat_longitude') is-invalid @enderror" rows="2"
                                    placeholder="Titik Longitude">{{ old('koordinat_longitude') }}</input>
                        ...
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-sm-7">
                                <input name="koordinat_latitude"
                                    class="form-control @error('koordinat_latitude') is-invalid @enderror" rows="2"
                                    placeholder="Titik Latitude">{{ old('koordinat_latitude') }}</input>
