...
<div class="container card p-4">
    ...
    <ol class="breadcrumb col-lg-12">
        ...
        <li><a href="/gedung" class="px-1">Gedung (<span id=""></span>)</a></li> 
        <span class="px-2">|</span>
        <li><a href="" class="breadcrumb-item  px-1 fw-bold text-success">Ruangan (<span id="absensiCount"></span>)</a></li>
    ...
    @foreach ($ruangan as $rgn)
        <tr>
          ...
          <td class="text-center">        
            <a href="/gedung/edit-ruangan/{{ $rgn->id }}" class="badge bg-warning mb-1" data-bs-toggle="tooltip"><i class="fas fa-pen"></i></a>   
            <button type="button" class="badge bg-danger border-0 text-center modalDeleted" value="{{ $rgn->id }}">
