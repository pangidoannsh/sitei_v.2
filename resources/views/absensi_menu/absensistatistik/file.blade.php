...
<body>
  ...
  border-collapse: collapse; width: 670px; margin: auto; font-size: 14px;">  
    <thead>
        ...
        <tr>
            <th class="text-center" style="width:76px">1</th>
            <th class="text-center" style="width:76px">2</th>
            <th class="text-center" style="width:76px">3</th>
            <th class="text-center" style="width:76px">4</th>
        </tr>
    </thead> 
        <tbody>
            @php
    ...
    @foreach ($groupedAttendances as $perkuliahanId => $attendances)
        ...
        <td class="text-center" style="text-align: center">{{ $created_at[$perkuliahanId] ?? '-' }}</td>
    @endforeach
    @for ($i = count($groupedAttendances) + 1; $i <= 4; $i++)
        <!-- Jika jumlah pertemuan kurang dari 4, tampilkan sel kosong -->
        <td class="text-center" style="text-align: center">-</td>
...
<tr>
    ...
    @foreach ($groupedAttendances as $perkuliahanId => $attendances)
        ...
        <td class="text-center" style="text-align: center">{{ $materi[$perkuliahanId] ?? '-' }}</td>
    @endforeach
    @for ($i = count($groupedAttendances) + 1; $i <= 4; $i++)
        <!-- Jika jumlah pertemuan kurang dari 4, tampilkan sel kosong -->
        <td class="text-center" style="text-align: center">-</td>
