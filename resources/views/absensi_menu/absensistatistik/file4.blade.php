...
<body>
  ...
  border-collapse: collapse; width: 670px; margin: auto; font-size: 14px;">  
    <thead>
        ...
        <tr>
            <th class="text-center" style="width:76px">13</th>
            <th class="text-center" style="width:76px">14</th>
            <th class="text-center" style="width:76px">15</th>
            <th class="text-center" style="width:76px">16</th>
        </tr>
    </thead> 
        <tbody>
            @php
    ...
    @endforeach
    @for ($i = count($groupedAttendances4) + 1; $i <= 4; $i++)
    ...
    @foreach ($groupedAttendances4 as $perkuliahanId => $attendances)
        ...
        <td class="text-center" style="text-align: center">{{ $tanggal4[$perkuliahanId] ?? '-' }}</td>
    @endforeach
    @for ($i = count($groupedAttendances4) + 1; $i <= 4; $i++)
        <!-- Jika jumlah pertemuan kurang dari 4, tampilkan sel kosong -->
        <td class="text-center" style="text-align: center">-</td>
...
<tr>
    ...
    @foreach ($groupedAttendances4 as $perkuliahanId => $attendances)
        ...
        <td class="text-center" style="text-align: center">{{ $materi4[$perkuliahanId] ?? '-' }}</td>
    @endforeach
    @for ($i = count($groupedAttendances4) + 1; $i <= 4; $i++)
        <!-- Jika jumlah pertemuan kurang dari 4, tampilkan sel kosong -->
        <td class="text-center" style="text-align: center">-</td>
