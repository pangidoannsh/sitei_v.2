...
<div>
    <div class="container card p-4">
        <ol class="breadcrumb col-lg-12">
            <li><a href="{{ route('absensistatistikadmin') }}" class="px-1 fw-bold text-success">Statistik Absensi (<span id="absensiCount"></span>)</a></li> 
            <span class="px-2">|</span>
            <li><a href="{{ route('statistik-ruangan') }}" class="breadcrumb-item  px-1">Ruangan (<span id=""></span>)</a></li>   
...
<table class="table table-responsive-lg text-center table-bordered table-striped" style="width:100%" id="datatables">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @if ($data->class == !null)
                    <td>{{$data->class->semester->semester ?? '-' }} {{$data->class->semester->tahun_ajaran ?? '-' }}</td>
                    ...
                    <td class="text-center">
                        <a href="{{ route('detailStatistik', ['class_id' => $data->class->id]) }}" class="badge btn btn-info p-1 mb-1 mr-1" data-bs-toggle="tooltip" title="Lihat Detail"><i class="fas fa-info-circle" aria-hidden="true"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
