...
<body>
  ...
  border-collapse: collapse; width: 670px; margin: auto; font-size: 14px;">  
    <thead>
        ...
        <tr>
            <th class="text-center" style="width:76px">5</th>
            <th class="text-center" style="width:76px">6</th>
            <th class="text-center" style="width:76px">7</th>
            <th class="text-center" style="width:76px">8</th>
        </tr>
    </thead> 
        <tbody>
            @php
    ...
    @endforeach
    @for ($i = count($groupedAttendances2) + 1; $i <= 4; $i++)
    ...
    @foreach ($groupedAttendances2 as $perkuliahanId => $attendances)
        ...
        <td class="text-center" style="text-align: center">{{ $tanggal[$perkuliahanId] ?? '-' }}</td>
    @endforeach
    @for ($i = count($groupedAttendances2) + 1; $i <= 4; $i++)
        <!-- Jika jumlah pertemuan kurang dari 4, tampilkan sel kosong -->
        <td class="text-center" style="text-align: center">-</td>
...
<tr>
    ...
    @foreach ($groupedAttendances2 as $perkuliahanId => $attendances)
        ...
        <td class="text-center" style="text-align: center">{{ $materi2[$perkuliahanId] ?? '-' }}</td>
    @endforeach
    @for ($i = count($groupedAttendances2) + 1; $i <= 4; $i++)
        <!-- Jika jumlah pertemuan kurang dari 4, tampilkan sel kosong -->
        <td class="text-center" style="text-align: center">-</td>
