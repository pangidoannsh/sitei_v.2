...
<div>
    <div class="container card p-4">
        <ol class="breadcrumb col-lg-12">
            <li><a href="/absensimahasiswa" class="px-1">Absensi (<span id=""></span>)</a></li> 
            <span class="px-2">|</span>
            <li><a href="{{ route('riwayatabsensi') }}" class="breadcrumb-item  px-1 fw-bold text-success">Riwayat Absensi (<span id="absensiCount"></span>)</a></li>   
