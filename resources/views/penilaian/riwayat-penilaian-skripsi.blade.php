...
@section('content')
    ...
    <div class="container card  p-4">
        ...
        <ol class="breadcrumb col-lg-12">
            ...
            <span class="px-2">|</span>
            <li><a href="/kp-skripsi/riwayat-penilaian-skripsi"
                    class="breadcrumb-item active fw-bold text-black px-1">Riwayat Seminar</a></li>
            (<span id=""></span>)
            <span class="px-2">|</span>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a formtarget="_blank" target="_blank"
                                ...
                                style="border-radius:20px;">Lihat Nilai</a>
