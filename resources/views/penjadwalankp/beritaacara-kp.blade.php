        ...
        <table width="100%" style="text-align:center; margin-top:0px;">
            <tr>
                <td style="font-size:12pt;text-decoration: underline;">
                    <strong>BERITA ACARA SEMINAR KERJA PRAKTEK</strong> </td>
            </tr>
        </table>
        ...
        <tr>
            ...
            <td class="text" style="text-align: left;">
                <div class="container">
                    ...
                    <br><br><br><br><br><br>
                    <strong style="text-decoration: underline;">{{$penjadwalan->pembimbing->nama}}</strong><br>NIP. {{$penjadwalan->pembimbing->nip}}
                </div>
                <br>
            </td>
        </tr>
