            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="mb-3 field">
                        ...
                        <input type="text" name="judul_kp" class="form-control @error('judul_kp') is-invalid @enderror"
                            value="{{ old('judul_kp') }}">
                        @error('judul_kp')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="col-md">
                    ...
                    <div class="mb-3 field">
                        ...
                        <select name="pembimbing_nip" id="pembimbing"
                            class="form-select @error('pembimbing_nip') is-invalid @enderror">
                            <option value="">-Pilih-</option>
                            @foreach ($dosens as $dosen)
                                <option value="{{ $dosen->nip }}"
                                    {{ old('pembimbing_nip') == $dosen->nip ? 'selected' : null }}>{{ $dosen->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3 field">
                        ...
                        <select name="penguji_nip" id="penguji"
                            ...
                            @foreach ($dosens as $dosen)
                                <option value="{{ $dosen->nip }}"
                                    {{ old('penguji_nip') == $dosen->nip ? 'selected' : null }}>{{ $dosen->nama }}
                                </option>
                            @endforeach
                        </select>
                        @error('penguji_nip')
